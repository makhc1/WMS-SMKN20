            ...
            <div class="max-w-4xl mx-auto flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 font-medium">Perbarui profil dan hak akses: {{ user.name }} ({{ user.email }})</p>
                    </div>
                </div>
            </div>
        </template>
                ...
                <form @submit.prevent="submit" class="p-8 sm:p-10 space-y-10 divide-y divide-black/5">
                    ...
                    <div class="space-y-6 pt-0">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Nama lengkap, alamat email, dan penugasan hak akses.</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6 pt-10">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-base font-semibold tracking-tight text-black">Reset Kata Sandi</h3>
                                <p class="text-xs text-gray-500">Kosongkan jika tidak ingin mengubah kata sandi pengguna ini.</p>
                            </div>
                        </div>
