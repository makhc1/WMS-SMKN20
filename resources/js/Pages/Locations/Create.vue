                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl sm:text-3xl font-bold tracking-tight text-black leading-tight">
                            Tambah Lokasi / Rak Gudang
                        </h2>
                        <p class="text-xs text-gray-500 font-medium">Definisikan nomor rak, zona penyimpanan, dan tipe penyimpanan barang.</p>
                    </div>
                </div>
            </div>
        </template>
            ...
            <div class="bg-white border border-black/10 rounded-3xl shadow-sm overflow-hidden">
                <form @submit.prevent="submit" class="p-8 sm:p-10 space-y-10 divide-y divide-black/5">
                    ...
                    <div class="space-y-6 pt-0">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Kode penamaan rak dan zona gedung penyimpanan.</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    v-model="form.code"
                                    required
                                    placeholder="Contoh: RAK-A01, BIN-12"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    v-model="form.name"
                                    required
                                    placeholder="Contoh: Rak Susun Elektronik Lantai 1"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Zona A - Gedung Praktik TKJ"
                                    class="w-full px-4 py-3 rounded-xl bg-white border border-black/10 focus:border-black focus:ring-1 focus:ring-black transition-all text-sm"
                                />
                    ...
                    <div class="space-y-6 pt-10">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Tipe ruangan penyimpanan, persentase kapasitas, dan status pemakaian.</p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-8">
                        ...
                        >
                            <span>{{ form.processing ? 'Menyimpan...' : 'Simpan Lokasi Rak' }}</span>
                        </button>
                    </div>
                </form>
            </div>
